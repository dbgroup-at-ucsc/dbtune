...
public class MinQueue<E> {
	...
	private final void set(int i, long priority, Object elt) {
	...
	public void insertKey(E elt, long priority) {
		int i;
	...
	public final long bestPriority() {
		if (size == 0)
			return -1;
		else 
			return priorities[1];
