...
public class PGIndex extends AbstractIndex implements Serializable {
   ...
   *
   * @param schema a {@link PGIndexSchema} object.
   * @param internalId {@link edu.ucsc.dbtune.core.DBIndex}'s internalId.
   * @param creationCost {@link edu.ucsc.dbtune.core.DBIndex}'s creation cost.
   * @param megabytes {@link edu.ucsc.dbtune.core.DBIndex}'s size (in megabytes).
   * @param creationText {@link edu.ucsc.dbtune.core.DBIndex}'s creation text.
   */
  public PGIndex(
