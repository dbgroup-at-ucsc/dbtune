...
public class PGIndexSchema implements DatabaseIndexSchema, Serializable {
   ...
   *
   * @param reloid relation object id
   * @param isSync indicate whether is sync or not.
   * @param columns a list of {@link DatabaseColumn columns}.
   * @param isDescending indicate whether is in descending order.
   */
  ...
  public boolean equals(Object that) {
    if (!(that instanceof PGIndexSchema)) { return false; }
  ...
  /**
   * @return the signature of {@link edu.ucsc.satuning.db.DBIndex}
   */
  String getSignature() {
    return signature;
  }
