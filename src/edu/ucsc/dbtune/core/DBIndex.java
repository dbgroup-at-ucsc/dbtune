...
public interface DBIndex {
   ...
   * @throws java.sql.SQLException unable to duplicate an index for the stated reasons.
   */
   ...
   *
   * @param name qualied name to be used in the comparison.
   * @return {@code true} if both qualified names are the same, false otherwise.
   */
