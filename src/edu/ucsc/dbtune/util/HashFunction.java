...
public class HashFunction {
    ...
    /* 
     * MD5 stuff
     * 'digest' is the 128-but output of the MD5 algorithm, which is executed
     * by calling setDigest()  
     */
    private static MD5 md = new MD5();
    private static byte[] digest = new byte[16];
    private static void setDigest(byte[] key) {
        md.init();
        md.update(key);
        md.md5final(digest);
    }
...
class MD5 {
    ...
    public void init() {
        ...
        java.util.Arrays.fill(inint, (byte) 0);
