...
import edu.ucsc.satuning.db.JdbcDatabaseConnectionManager;
...
import static edu.ucsc.satuning.db.ibm.DB2Commands.readAdviseOnOneIndex;
import static edu.ucsc.satuning.db.ibm.DB2ReifiedTypes.DB2IndexSet;
...
public class Advisor {
	...
	private static String getCmd(DatabaseConnection<DB2Index> conn, String advisorPath, int budget, File inFile, boolean clean) {
		...
		final String db   = manager.getDatabase();
