...
import edu.ucsc.satuning.util.HashFunction;
...
public class DB2IndexSchema implements DatabaseIndexSchema, Serializable, Comparable<DB2IndexSchema> {
    ...
    private QualifiedName tableQualifiedName;
    ...
    DB2IndexSchema(
		...
		this.tableQualifiedName = new QualifiedName(this.dbName, this.tableCreatorName, this.tableName);
	}
    ...
    public QualifiedName getBaseTable() {
