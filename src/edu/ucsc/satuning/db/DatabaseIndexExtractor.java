 ...
 * {@link edu.ucsc.satuning.engine.profiling.Profiler profiler}) and suggest optimal
...
public interface DatabaseIndexExtractor<I extends DBIndex<I>> {
    ...
    /**
     * provides information dealing with the {@link ExplainInfo#maintenanceCost(DBIndex) maintenance
     * cost} associated with the use of a given index.
     *
     * @param sql
     *      sql query.
     * @return
     *      a new {@link ExplainInfo} instance.
     * @throws SQLException
