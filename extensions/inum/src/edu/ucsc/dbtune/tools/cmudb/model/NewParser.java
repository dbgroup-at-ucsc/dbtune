...
public class NewParser {
    ...
    public NewParser() {
        ...
        File metadataFile = edu.ucsc.dbtune.tools.cmudb.Config.getMetadataFile();
    ...
    public static void main(String[] args) throws IOException {
        new NewParser().parseSQL(edu.ucsc.dbtune.tools.cmudb.Config.getWorkloadFile("test-1.sql"));
    }
