...
import edu.ucsc.dbtune.tools.cmudb.autopilot.PostgresPlan;
...
//            System.out.println(i + "\t" + index.getKey() + "_NLJ_\t" + cost);
    ...
    public static void postgresIndexAccessGeneratorMain(String filName) throws ParseException, IOException {
        ...
        WorkloadProcessor proc = new WorkloadProcessor(new File(edu.ucsc.dbtune.tools.cmudb.Config.WORKLOAD_DIR, filName));
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        WorkloadProcessor proc = new WorkloadProcessor(new File(edu.ucsc.dbtune.tools.cmudb.Config.WORKLOAD_DIR, args[0]));
        proc.getInterestingOrders();
        proc.generateCandidateIndexes();
