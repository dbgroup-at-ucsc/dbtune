...
import edu.ucsc.dbtune.tools.cmudb.DbType;
...
public class idx_cleaner {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if(edu.ucsc.dbtune.tools.cmudb.Config.TYPE.equals(DbType.MS))
                cleanIndexesMS(prefix, conn);
            else if(edu.ucsc.dbtune.tools.cmudb.Config.TYPE.equals(DbType.DB2))
                cleanIndexesDB2(prefix, conn);
            else if(edu.ucsc.dbtune.tools.cmudb.Config.TYPE.equals(DbType.PGSQL)) {
