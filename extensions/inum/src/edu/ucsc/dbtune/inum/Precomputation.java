...
public interface Precomputation {
   ...
   * by calling the {@link InumSpace#save(Set) InumSpace#save(Set<OptimalPlan>)} method.
   ...
   */
  Set<OptimalPlan> setup(String workload, Iterable<DBIndex> configuration);
