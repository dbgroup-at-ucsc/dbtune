...
/**
 * It calls the dbms to obtain the necessary column information to help the extraction of
 * interesting orders.
 *
...
public interface ColumnPropertyLookup {
  /**
   * Obtain {@link ColumnInformation column information} of a given {@code reloid}.
   *
   * @param reloid relation oid.
   ...
   *
   * @param tableName name of the table where the column is.
   * @param columnName name of the column we are interested.
   * @return the type of the column. -1 if not found.
   */
  int getColumnDataType(String tableName, String columnName);

  /**
   * @return a live {@link Connection db connection}.
   ...
   *
   * @param key property's assigned key.
