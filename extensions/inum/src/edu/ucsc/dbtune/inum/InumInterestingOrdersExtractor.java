 ...
 */
public class InumInterestingOrdersExtractor
    implements InterestingOrdersExtractor
{
        ...
        throws SQLException
    {
        ...
        for(String name : names) {
            ...
            if(c == null)
                throw new RuntimeException("column " + name + " not found in " + table);
    ...
    private static class ColumnsExtractor
    {
        ...
        public Set<String> getInterestingOrders() {
            ...
            for (String each : joinColumns)
                caps.add(each.toUpperCase());

            for (String each : groupByColumns)
                caps.add(each.toUpperCase());

            for (String each : orderByColumns)
                caps.add(each.toUpperCase());
    ...
    public enum ColumnsProperties implements ColumnPropertyLookup {
        ...
        @Override
        public Set<ColumnInformation> getColumnInformation(int reloid)
        {
