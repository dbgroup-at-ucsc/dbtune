...
public class OptimalPlansParserTest {
  private static final String EXECUTION_PLAN
      = "Hash Join  (cost=174080.39..9364262539.50 rows=1 width=193)";

  @Test public void testParsingOptimalPlans() throws Exception {
    final OptimalPlan plan = new InumOptimalPlansParser().parse(EXECUTION_PLAN);
    assertThat(plan != null, is(true));
