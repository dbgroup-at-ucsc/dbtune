...
DB2_CONFIG="jdbc.url=jdbc:db2://aigaion.soe.ucsc.edu:50000/test\n\
...
echo $DB2_CONFIG >> $DBTUNECONFIG
echo $DBMS_CONFIG >> $DBTUNECONFIG
...
cat bin/base.cfg > $DBTUNECONFIG
echo $DB2_CONFIG >> $DBTUNECONFIG
echo $IBG_ON_INUM_CONFIG >> $DBTUNECONFIG
ant -lib lib functional.all
