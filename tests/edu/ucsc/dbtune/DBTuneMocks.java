...
public class DBTuneMocks
{
    ...
    {
        public ExplainedSQLStatement explain(SQLStatement sql)
        {return null;}
        public ExplainedSQLStatement explain(SQLStatement sql, Configuration conf)
        {return null;}
        public Configuration recommendIndexes(SQLStatement sql)
        {return null;}
    }
    ...
    static class MockPreparedStatement extends MockStatement implements PreparedStatement {
        final AtomicReference<String> sql = new AtomicReference<String>();
