...
public class ParametersTest {
    ...
    public void testInterfaceRetrievalMultipleImpls() throws Exception {
        ...
        final SomeType  type  = param.getParameterValue(SomeType.class);
        assertNotNull(type);
        assertTrue(type instanceof SomeTypeImpl);
        assertFalse("it should not say You again?", "You again?".equalsIgnoreCase(type.name()));
    ...
    public void testGenericInterfaceCase() throws Exception {
        final List<SomeType> types = Instances.newList();
